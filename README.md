...
Вендерные префиксы - это префиксы к свойствам css, которые обеспечивают работу свойств в других браузерах, где это свойство еще не добавлено глобально
Основные префиксы:

- -webkit - браузеры на Chromium (выше 3 версии)
- -moz - FireFox
- -ms - браузеры Microsoft
- -o - Opera
